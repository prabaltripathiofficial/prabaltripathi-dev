  ...
  return (
    <div className="max-w-5xl mb-40 flex flex-col md:flex-row mx-4 mt-8 md:mt-20 lg:mt-32 lg:mx-auto">
      ...
      <main className="flex-auto min-w-0 mt-6 md:mt-0 flex flex-col">
        ...
        {/* min-height ≈ the About page's natural content height, so the footer
            sits at the same spot on short pages (About is the floor) and still
            flows down when a page has more content. */}
        <div className="flex-auto min-h-[23rem]">{children}</div>
        <Footer />
      </main>
    </div>
  );
